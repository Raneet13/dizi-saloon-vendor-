...
class DomyHomeScreen extends StatefulWidget {
  const DomyHomeScreen({super.key});

  @override
  State<DomyHomeScreen> createState() => _DomyHomeScreenState();
}

class _DomyHomeScreenState extends State<DomyHomeScreen> {
  //  DomyHomeScreen({super.key}) : super();
            ...
            ()=>home.isLoading.value?JumpingDotsScreen(): Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: HomeSlider(bannerDtl: home.homemodel.value.messages?.data?.bannerDtl??[],dotFalse: true,)
                   ),
               ...
               home.homemodel.value.messages?.data?.reciveOrder !=true? Padding(
                  ...
                  child: KYCWidget(saalon: home.homemodel.value.messages?.data?.loginUser,gologin:true)
                  ):
                   Padding(

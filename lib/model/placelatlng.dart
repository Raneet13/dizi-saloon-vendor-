class PlaceLatlong {
  ...
  PlaceLatlong({this.htmlAttributions, this.result, this.status});

  PlaceLatlong.fromJson(Map<String, dynamic> json) {
    htmlAttributions = json['html_attributions'].cast<dynamic>();
    result =

...
//
//     final getplaceGeoCode = getplaceGeoCodeFromJson(jsonString);

import 'dart:convert';

GetplaceGeoCode getplaceGeoCodeFromJson(String str) => GetplaceGeoCode.fromJson(json.decode(str));

String getplaceGeoCodeToJson(GetplaceGeoCode data) => json.encode(data.toJson());

class GetplaceGeoCode {
    PlusCode? plusCode;
    List<Result>? results;
    String? status;
    ...
    factory GetplaceGeoCode.fromJson(Map<String, dynamic> json) => GetplaceGeoCode(
